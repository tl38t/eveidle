...
function getQueueSkillLabel(skill) {
  const labels = { mining:"⛏采矿", refining:"🔥冶炼", gasHarvesting:"☁️气体", shipEngineering:"🚀舰船", equipmentEngineering:"🔧装备工程", archaeology:"🔍考古", boosterEngineering:"💉增强剂", blueprintInvention:"🧬蓝图发明", combat:"⚔战斗" };
