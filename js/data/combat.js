...
const COMBAT_ZONES = [
  ...
  { id:"angel_hunting_ground", name:"苍穹劫团猎杀空域", faction:"angel", secLevel:"0.4-0.3", level:40, requiredCL:35, icon:"👹", enemyPool:{normal:["strike_cruiser"],elite:["war_cruiser"],boss:["fleet_commander"]}, formationPool:"lowsec", bossEscortCount:1, maxWave:20, clearLp:10, iskMulti:2.0, fuelMult:1.2, encryptedDataMaterial:"天使中级加密数据", stationCoreDrops:[{coreId:"smelt", resourceId:"special:空间站冶炼核心", qty:1, chances:{elite:0.000794,boss:0.00397}}], gearDrops:[{resourceId:"special:苍穹劫团装备生产许可B", qty:1, chances:{elite:0.01,boss:0.04}}] },
  ...
  { id:"angel_warfront", name:"苍穹劫团破阵战场", faction:"angel", secLevel:"0.2-0.1", level:60, requiredCL:55, icon:"👹", enemyPool:{normal:["siege_battleship"],elite:["marauder_battleship"],boss:["war_master"]}, formationPool:"deepsec", bossEscortCount:1, maxWave:20, clearLp:15, iskMulti:2.5, fuelMult:1.35, encryptedDataMaterial:"天使高级加密数据", gearDrops:[{resourceId:"special:苍穹劫团装备生产许可A", qty:1, chances:{elite:0.01,boss:0.04}}] },
  { id:"blood_iron_basilica", name:"赤誓教团铁血圣殿", faction:"blood", secLevel:"0.2-0.1", level:60, requiredCL:55, icon:"🧛", enemyPool:{normal:["iron_battleship"],elite:["apostle_battleship"],boss:["blood_sovereign"]}, formationPool:"deepsec", bossEscortCount:1, maxWave:20, clearLp:15, iskMulti:2.5, fuelMult:1.35, encryptedDataMaterial:"血袭者高级加密数据", gearDrops:[{resourceId:"special:赤誓教团装备生产许可A", qty:1, chances:{elite:0.01,boss:0.04}}] },
  { id:"sansha_command_matrix", name:"静默集群统御矩阵", faction:"sansha", secLevel:"0.2-0.1", level:60, requiredCL:55, icon:"🤖", enemyPool:{normal:["command_battleship"],elite:["domination_battleship"],boss:["matrix_overlord"]}, formationPool:"deepsec", bossEscortCount:1, maxWave:20, clearLp:15, iskMulti:2.5, fuelMult:1.35, encryptedDataMaterial:"萨沙高级加密数据", gearDrops:[{resourceId:"special:静默集群装备生产许可A", qty:1, chances:{elite:0.01,boss:0.04}}], stationCoreDrops:[{coreId:"shipEng", resourceId:"special:空间站船坞核心", qty:1, chances:{elite:0.000690,boss:0.00345}}] }
...
// （angel 自 tier2 全档 / blood 仅 tier4、tier6 / sansha 仅 tier6）。
