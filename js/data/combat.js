...
const WEAPON_CONFIG = {
  ...
  missile: { name:"导弹发射器", damageType:"explosive", baseDps:100, fuelCost:2, baseHit:130, counterType:"armor",     icon:"🚀", skillKey:"missileOperations" },
  cannon:  { name:"炮台",       damageType:"kinetic",   baseDps:80,  fuelCost:1, baseHit:80,  counterType:"structure", icon:"💣", skillKey:"cannonOps" }
};
...
const COMBAT_ZONES = [
  { id:"angel_outpost",  name:"苍穹劫团前哨站",  faction:"angel",  secLevel:"1.0-0.8", level:1, icon:"👹", enemyPool:{normal:["scout"],elite:["raider"],boss:["commander"]}, formationPool:"highsec", bossEscortCount:1, maxWave:20, clearLp:3, iskMulti:1.0, encryptedDataMaterial:"天使初级加密数据", gearDrops:[{resourceId:"special:苍穹劫团装备生产许可D", qty:1, chances:{elite:0.005,boss:0.035}}], encryptedDataDisabled:true },
  { id:"blood_hideout",  name:"赤誓教团隐蔽所", faction:"blood",  secLevel:"1.0-0.8", level:1, icon:"🧛", enemyPool:{normal:["acolyte"],elite:["priest"],boss:["cardinal"]}, formationPool:"highsec", bossEscortCount:1, maxWave:20, clearLp:3, iskMulti:1.0, encryptedDataMaterial:"血袭者初级加密数据", gearDrops:[{resourceId:"special:赤誓教团装备生产许可D", qty:1, chances:{elite:0.005,boss:0.035}}], encryptedDataDisabled:true },
  { id:"sansha_outpost", name:"静默集群哨站",     faction:"sansha", secLevel:"1.0-0.8", level:1, icon:"🤖", enemyPool:{normal:["drone"],elite:["sentinel"],boss:["overlord"]}, formationPool:"highsec", bossEscortCount:1, maxWave:20, clearLp:3, iskMulti:1.0, encryptedDataMaterial:"萨沙初级加密数据", gearDrops:[{resourceId:"special:静默集群装备生产许可D", qty:1, chances:{elite:0.005,boss:0.035}}], encryptedDataDisabled:true },
  { id:"angel_corridor", name:"苍穹劫团劫掠走廊", faction:"angel", secLevel:"0.7-0.5", level:20, requiredCL:15, icon:"👹", enemyPool:{normal:["patrol_destroyer"],elite:["raider_destroyer"],boss:["hunter_commander"]}, formationPool:"bordersec", bossEscortCount:1, maxWave:20, clearLp:6, iskMulti:1.5, fuelMult:1.2, encryptedDataMaterial:"天使低级加密数据", gearDrops:[{resourceId:"special:苍穹劫团装备生产许可C", qty:1, chances:{elite:0.005,boss:0.035}},{resourceId:"special:苍穹劫团装备生产许可B", qty:1, chances:{elite:0.005,boss:0.035}}] },
  { id:"blood_sacrifice", name:"赤誓教团献祭场", faction:"blood", secLevel:"0.7-0.5", level:20, requiredCL:15, icon:"🧛", enemyPool:{normal:["ritual_destroyer"],elite:["blood_destroyer"],boss:["high_priest"]}, formationPool:"bordersec", bossEscortCount:1, maxWave:20, clearLp:6, iskMulti:1.5, fuelMult:1.2, encryptedDataMaterial:"血袭者低级加密数据", gearDrops:[{resourceId:"special:赤誓教团装备生产许可C", qty:1, chances:{elite:0.005,boss:0.035}}] },
  { id:"sansha_node", name:"静默集群控制节点", faction:"sansha", secLevel:"0.7-0.5", level:20, requiredCL:15, icon:"🤖", enemyPool:{normal:["control_destroyer"],elite:["sentinel_destroyer"],boss:["control_overlord"]}, formationPool:"bordersec", bossEscortCount:1, maxWave:20, clearLp:6, iskMulti:1.5, fuelMult:1.2, encryptedDataMaterial:"萨沙低级加密数据", gearDrops:[{resourceId:"special:静默集群装备生产许可C", qty:1, chances:{elite:0.005,boss:0.035}}] },
