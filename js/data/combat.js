...
const COMBAT_ZONES = [
  ...
  { id:"blood_hideout",  name:"赤誓教团隐蔽所", faction:"blood",  secLevel:"1.0-0.8", level:1, icon:"🧛", enemyPool:{normal:["acolyte"],elite:["priest"],boss:["cardinal"]}, formationPool:"highsec", bossEscortCount:1, maxWave:20, clearLp:3, iskMulti:1.0, encryptedDataMaterial:"血袭者初级加密数据", encryptedDataDisabled:true },
