...
const COMBAT_ZONES = [
  { id:"angel_outpost",  name:"苍穹劫团前哨站",  faction:"angel",  secLevel:"1.0-0.8", level:1, icon:"👹", enemyPool:{normal:["scout"],elite:["raider"],boss:["commander"]}, formationPool:"highsec", bossEscortCount:1, maxWave:20, clearLp:3, iskMulti:1.0, encryptedDataMaterial:"天使初级加密数据" },
  ...
  { id:"sansha_outpost", name:"静默集群哨站",     faction:"sansha", secLevel:"1.0-0.8", level:1, icon:"🤖", enemyPool:{normal:["drone"],elite:["sentinel"],boss:["overlord"]}, formationPool:"highsec", bossEscortCount:1, maxWave:20, clearLp:3, iskMulti:1.0, encryptedDataMaterial:"萨沙初级加密数据" },
  ...
  { id:"sansha_command_matrix", name:"静默集群统御矩阵", faction:"sansha", secLevel:"0.2-0.1", level:60, requiredCL:55, icon:"🤖", enemyPool:{normal:["command_battleship"],elite:["domination_battleship"],boss:["matrix_overlord"]}, formationPool:"deepsec", bossEscortCount:1, maxWave:20, clearLp:15, iskMulti:2.5, fuelMult:1.6, encryptedDataMaterial:"萨沙高级加密数据", encryptedDataChances:{elite:0.03,boss:0.08} }
...
const COMBAT_SPECIAL_MATERIALS = [...STAR_BELT_DATA_MATERIALS, ...DEATHSPACE_TICKET_MATERIALS, ...DEATHSPACE_LOOT_MATERIALS, ...SUPERCAPITAL_DATA_MATERIALS, ...TACTICAL_MATERIAL_IDS];
