...
const SHIP_ASSEMBLY_RECIPES = [
  ...
  { id:"dawnbreaker", name:"破晓级", shipId:"dawnbreaker", level:60, time:120, xp:200, componentCost:{battleship_integrated_hull:6,battleship_power_core:5,battleship_functional_system:5}, materialCost:{"钷":20,"铷":16,"天使高级加密数据":45} },
  { id:"crimson_bastion", name:"赤垒级", shipId:"crimson_bastion", level:60, time:120, xp:200, componentCost:{battleship_integrated_hull:6,battleship_power_core:5,battleship_functional_system:5}, materialCost:{"钷":20,"铷":16,"血袭者高级加密数据":45} },
  { id:"spectre_frame", name:"幽构级", shipId:"spectre_frame", level:60, time:120, xp:200, componentCost:{battleship_integrated_hull:6,battleship_power_core:5,battleship_functional_system:5}, materialCost:{"钷":20,"铷":16,"萨沙高级加密数据":45} },
...
const STARTER_SHIPS = {
  ...
  firmament: {
    ...
    capacitor: { capacity: 650, rechargeRate: 26 },
    fuelEfficiency: 0.78,
  ...
  heavy_bastion: {
    ...
    capacitor: { capacity: 620, rechargeRate: 26 },
    fuelEfficiency: 0.68,
  ...
  starcrown: {
    ...
    capacitor: { capacity: 850, rechargeRate: 32 },
    fuelEfficiency: 0.72,
  ...
  eternal_fortress: {
    ...
    capacitor: { capacity: 820, rechargeRate: 32 },
    fuelEfficiency: 0.62,
...
const ARCHAEOLOGY_SHIPS = {
  ...
  tracer: {
    ...
    capacitor: { capacity: 140, rechargeRate: 7 },
    fuelEfficiency: 0.95,
  ...
  starmap: {
    ...
    capacitor: { capacity: 200, rechargeRate: 10 },
    fuelEfficiency: 0.90,
  ...
  farscope: {
    ...
    capacitor: { capacity: 280, rechargeRate: 14 },
    fuelEfficiency: 0.85,
  ...
  illuminator: {
    ...
    capacitor: { capacity: 400, rechargeRate: 20 },
    fuelEfficiency: 0.80,
