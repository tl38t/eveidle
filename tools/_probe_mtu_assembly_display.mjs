...
const sb = { alert: noop, Blob, CanvasRenderingContext2D: Ctx, console, confirm: () => true, document: { addEventListener: noop, readyState: "loading", body: mkEl(), createElement: () => mkEl(), getElementById: () => mkEl(), querySelector: () => mkEl(), querySelectorAll: () => [] }, FileReader: class {}, localStorage: { getItem: () => null, setItem: noop, removeItem: noop }, matchMedia: () => ({ matches: false, addEventListener: noop, removeEventListener: noop }), requestAnimationFrame: noop, setInterval: () => 0, setTimeout: () => 0, clearTimeout: noop, URL: { createObjectURL: () => "b", revokeObjectURL: noop }, window: null };
sb.window = sb;
