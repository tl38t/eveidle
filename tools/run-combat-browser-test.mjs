// ================================================================
// 无头 Chrome 运行 tools/combat-browser-test.html 并返回 EXIT CODE。
...
// 用法：node tools/run-combat-browser-test.mjs [--keep-log]
// ================================================================
...
const url = `http://127.0.0.1:${port}/tools/combat-browser-test.html?autorun=1`;
const profile = await mkdtemp(join(tmpdir(), "eveidle-combat-test-"));
