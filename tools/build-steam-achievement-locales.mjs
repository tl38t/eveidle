...
const titleEn = {
  ...
  C01:'The First Rivet', C02:'Launch Ceremony', C03:'Under the Skyvault, Every Route Is Open', C04:'Heavy Bulwark: Mobile Fortress', C05:'Worldbreaker, Breaking Through the Lines', C06:'Mountains and Seas Can Be Leveled', C07:'Daybreak: The First Light of Dawn', C08:'Crowned by the Stars', C09:'Eternal City: The City That Never Falls', C10:'Verdict: Final Verdict', C11:'Blueprint: Civilization\'s Copier', C13:'The Oath of Twenty-Five Titans',
...
const shipEn = {'天穹级':'Skyvault-class','重垒级':'Bulwark-class','裂界级':'Worldbreaker-class','山海级':'Seamount-class','启明级':'Daybreak-class','星冕级':'Starcrown-class','恒城级':'Eternal City-class','裁决级':'Verdict-class'};
