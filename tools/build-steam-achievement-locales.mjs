...
const titleEn = {
  ...
  B01:'Tritanium Ore: The Beginning of Everything', B08:'Standard Titanium Is the Foundation of the Universe', B15:'Breaking the 1,000,000 Mark', B16:'Breaking the 100,000,000 Mark', B17:'Take a Deep Breath in the Nebula', B18:'Nebula Sustainer',
...
function translateCondition(s) {
  ...
  if (s==='首次采集 铁硅原矿') return 'Mine Tritanium Ore for the first time';
  ...
  if ((m=s.match(/^历史峰值持有 ([\d,]+) 星币$/))) return `Reach a historical holding peak of ${m[1]} ISK`;
